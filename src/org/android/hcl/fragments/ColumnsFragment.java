...
import org.android.adapters.ColumnsFragmentAdapter;
...
public class ColumnsFragment extends SherlockListFragment implements FeedListener{

	public static final String TAG = ColumnsFragment.class.getName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		feedLoader = new FeedLoader(getSherlockActivity(), getString(R.string.feed_hcl_columns), "feed_hcl_columns", this);
		feedLoader.execute();
	...
	public void onFeedAvailable(Rss feed) {
		...
		ColumnsFragmentAdapter adapter = new ColumnsFragmentAdapter(channel.getItems(), getSherlockActivity());
