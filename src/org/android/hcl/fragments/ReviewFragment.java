...
import org.android.adapters.ReviewFragmentAdapter;
...
public class ReviewFragment extends SherlockListFragment implements FeedListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		feedLoader = new FeedLoader(getSherlockActivity(), getString(R.string.feed_hcl_review), "feed_hcl_review", this);
		feedLoader.execute();
	...
	public void onFeedAvailable(Rss feed) {
		...
		ReviewFragmentAdapter adapter = new ReviewFragmentAdapter(channel.getItems(), getSherlockActivity());
