...
import org.android.adapters.InterviewFragmentAdapter;
...
public class InterviewFragment extends SherlockListFragment implements FeedListener{

	public static final String TAG = InterviewFragment.class.getName();
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		feedLoader = new FeedLoader(getSherlockActivity(), getString(R.string.feed_hcl_interview), "feed_hcl_interview", this);
		feedLoader.execute();
	...
	public void onFeedAvailable(Rss feed) {
		...
		InterviewFragmentAdapter adapter = new InterviewFragmentAdapter(channel.getItems(), getSherlockActivity());
