...
import org.android.adapters.AnnouncementsFragmentAdapter;
...
public class AnnouncementsFragment extends SherlockListFragment implements FeedListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		feedLoader = new FeedLoader(getSherlockActivity(), getString(R.string.feed_hcl_announcements), "feed_hcl_announcements", this);
		feedLoader.execute();
	...
	public void onFeedAvailable(Rss feed) {
		...
		AnnouncementsFragmentAdapter adapter = new AnnouncementsFragmentAdapter(channel.getItems(), getSherlockActivity());
